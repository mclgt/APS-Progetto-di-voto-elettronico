...
class ComuneBlockchainService:
    ...
    def sottometti_e_registra_voto(self, package_bytes: bytes)->tuple[bool, str, dict]:
        ...
        ricevuta_cittadino = {
            ...
            "leaf_hash": MerkleTree.hash_leaf(scheda["encrypted_vote"], scheda["token_voto"]).hex(),
...
class BachecaPubblica:
    ...
    def esegui_verifica_individuale(self, leaf_hash_hex: str, proof: list, expected_root_hex: str)->bool:
        """
        ...
        """
        return MerkleTree.verify_proof(leaf_hash_hex, proof, expected_root_hex)
